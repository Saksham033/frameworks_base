...
/**
 * Global user-level preferences for LLuvia-abilities
 * @hide
 */
public final class LLuviaSettings {
     ...
     * @hide
     */
    public static final String LLUVIA_SETTINGS_PREFIX = "lluvia::";
    ...
    public static Uri getUriFor(String name) {
        return Settings.Secure.getUriFor(LLUVIA_SETTINGS_PREFIX + name);
    }
